...
from sim_diff_drive_utils.utils.math_helpers import wrap_to_pi, yaw_to_quaternion
...
class OdometryLocalization(Node):
    ...
    def update_odometry(self):
        ...
        odom_msg = Odometry()
        odom_msg.header.stamp = rclpy.time.Time(seconds=self.now_time).to_msg()
        ...
        t = TransformStamped()
        t.header.stamp = rclpy.time.Time(seconds=self.now_time).to_msg()
